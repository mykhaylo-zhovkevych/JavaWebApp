...
public class DataUtility {
	  /**
	   * In summary, this utility class is designed to handle common data operations,
	   *  such as string manipulation, parsing strings to various data types (int, long, Date, Timestamp), 
	   *  and formatting Date objects to strings. 
