...
/* This class will be responsible to validate all the data that will come from the inputs fields.
 *  So we are going to write some methods that will help us to validate the input fields in java.*/
